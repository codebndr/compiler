...
class DefaultController extends Controller
{
	...
	{
		$parameters = array("cc", "cpp", "as", "ar", "ld", "clang", "objcopy", "logdir", "size", "cflags", "cppflags", "asflags", "arflags", "ldflags", "ldflags_tail", "clang_flags", "objcopy_flags", "size_flags", "output", "arduino_cores_dir", "auth_key");
