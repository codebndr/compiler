...
class DefaultController extends Controller
{
	...
	{
		$parameters = array("cc", "cpp", "ld", "clang", "objcopy", "size", "cflags", "cppflags", "ldflags", "ldflags_tail", "clang_flags", "objcopy_flags", "size_flags", "output", "root", "arduino_skel", "auth_key");
